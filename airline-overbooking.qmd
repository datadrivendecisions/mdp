...
def plot_policies(params=[(0.2, 0.05), (0.2, 0.1), (0.3, 0.05), (0.3, 0.1)], n=10):
    fig = go.Figure()
    ...
    param_colors = {}  # Dictionary to map each (p, q) to a specific color

    for idx, (p, q) in enumerate(params):
...
```{python}
params = [(0.2, 0.05), (0.2, 0.1), (0.3, 0.05), (0.3, 0.1)]
n=10
plot_policies(params, n)
```
